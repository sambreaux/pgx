...
cast_pheno<-dcast(fun_pheno2, MEDICATION+GENE~phenotype, fun.aggregate = mean, value.var = "Phenotype_freq")
...
### output files
*consideration_per_gene.csv = frequency each pharmcutical consideration occurs per gene
```{r congene}
...
### split combination drugs into indivdual component drugs
...
* interaction_samples.csv =  table of all interactions listed on the myDNA reports
```{r current meds}
...
#remove NAs, split sperate interaction data intoindividual rows, match case
...
#get  frequency of each ocnsideration
