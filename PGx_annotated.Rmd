...
### output files:
* my_vs_kailos_freq_pop

```{myDNA vs kailos genotype freq}
...
# missing drug 
from here on is me investigating the missing drug (acenocoumarol) in the three patients J02-131, L65-291, and N24-325
